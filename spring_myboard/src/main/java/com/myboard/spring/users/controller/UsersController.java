package com.myboard.spring.users.controller;
...
import com.myboard.spring.users.dto.UsersDto;
import com.myboard.spring.users.service.UsersService;
...
public class UsersController {
	...
	// 회원 탈퇴 요청 처리  users/delete 요청 처리하기
	...
	public Map<String, Object> profileUpload(HttpServletRequest request, MultipartFile image){
		...
		// 서비스를 이용해서 이미지를 upload 폴더에 저장하고 리턴하는 Map 을 리턴해서 json 문자열 응답하기
	...
	public ModelAndView pwdUpdate(UsersDto dto, ModelAndView mView, HttpSession session) {
		...
		// view page 로 forward 이동해서 작업결과를 응답한다.
	...
	public ModelAndView login(ModelAndView mView, UsersDto dto, String url, HttpSession session) {
		 ...
		 *  주로, HttpServletRequest, HttpServletResponse, HttpSession, ModelAndView 등등의 객체 이다. 
		 */
